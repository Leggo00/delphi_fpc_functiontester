...
function mergeParts(sessionId : APILONG; stationNr: APISTRING;  processLayer :APILONG; duplicateSerialNumber: APILONG; serialNumberMaster: APISTRING ;  serialNumberSlave: APISTRING; var errorString :APISTRING): APILONG; cdecl;
...
// Kim Flash Station
function verifyMergeBySnrRef(sessionId : APILONG;  stationNr : APISTRING;  serialNumberSlave: APISTRING; var testDataArraySize : APILONG; StateData : PTestDataArray; errorString: APISTRING): APILONG; cdecl;
...
function checkSnrStateBySnrRef(sessionId : APILONG; stationNr : APISTRING; processLayer : APILONG; serialNumber : APISTRING; var testDataArraySize : APILONG; StateData : PtestDataArray; var errorString : APISTRING): APILONG; cdecl;
...
function mergeParts;                     external DLL_Name;
...
function verifyMergeBySnrRef;          external DLL_Name;
