...
// ACU는 $55를 사용하고 그외의 ECU는 $FF를 사용함.    
    FILTER_BYTE = $FF;
//    FILTER_BYTE = $55;
...
type
  ...
  public
    ...
    function    SendPRESENT(Param : String) : Integer;
    ...
    try
        ...
        begin
            ...
            1: begin // 첫번쨰 응답을 기다린다.
                if ReadMsg(1, StrList, nTimeOut) > 0 then
                begin
                    CanMsg := StrToCanMsg( StrList[0] );
            ...
            4 : begin // Finished
                ...
                begin
                    ...
                    begin
                        ...
                        sResultStr := Format('* Negative Response : (%.2x) %s', [RxBuff[2], GetErrorCode(RxBuff[2])]);  // 비정상응답
                        Result := NEGATIVE_RES;
                    end else
                    begin
                        FRxLen := 0;
...
function TCanDiag.SendPRESENT(Param : String) : Integer;
const
    RETRYCOUNT = 1;
...
function TCanDiag.GetErrorCode(nError : Byte) : String;
begin
    case nError of
    ...
    begin
        ...
        try
            ...
            begin
                ...
                begin
                    if ((CanID = RxID) or (CanID = TxID)) and (bViewAllMsg) then
                    begin
