...
begin
    ...
    try
        ...
        repeat
            ...
            // Mask가 있는경우.
            RdStr := StrList.Values['MASK'];   // Ex) Str = 100~200,300~400
            while (RdStr <> '') do
            begin
                Str := GetToken(RdStr, ',');
...
begin
    ...
    Lock;
    try
        if (FConnected[nChannel]) and (m_xlPortHandle <> XL_INVALID_PORTHANDLE) then begin
...
begin
    ...
    begin
        ...
        try
            ...
            xlEvt.tagData.msg.dlc     := MAX(Value.DLC, 8);
...
begin
    ...
    try
        ...
        begin
            ...
            if ( xlStat <> XL_ERR_QUEUE_IS_EMPTY ) and (RxCount < High(RxMessages)) then
            begin
